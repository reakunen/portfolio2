...
import { ContactIcon, HomeIcon, MailIcon, NotebookIcon } from "lucide-react";
...
export const DATA = {
  ...
  description:
    "College student and part-time beekeeper 🐝 turned software engineer. I love new things and helping people.",
  summary:
