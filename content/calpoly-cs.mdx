...
Here's what I would rank the classes... in order!

If you're interested, these are the classes we have to take 
...
Oh also, the final was pretty brutal as well. I don't think he put in
the grades for the final because he couldn't grade it in time, which was
such a blessing - I would have lost my A in the class if he graded a little earlier...
...
class Node:
    def __init__(self, data):
        ...
        self.next = None
```
I had a lot of fun in this class and met my day one homies and friends in this class!
